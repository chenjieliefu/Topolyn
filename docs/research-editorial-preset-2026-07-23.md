...
Topolyn already has the deeper reading product: exact semantic identity, search,
...
- **Adapt:** keep Topolyn's exact existing SVG geometry and semantic palette;
...
- **Adapt:** exercise Route and Reach cards, Story, trace motion, dark/light,
  and canonical SVG through Topolyn's existing gates.
...
Topolyn's own landing-page paper identity and remains recognizable in both dark
and light themes.
