...
What should Topolyn add after Node Finder, Semantic Camera, Relationship Lens,
...
This is a useful boundary for Topolyn: the overview should preserve spatial
...
3. Node colors derived from Topolyn's authored semantic kinds.
