...
The remaining motion gap is similar: Topolyn's exact-edge Directional Flow Pulse
...
### Current Topolyn contract

`topolyn/assets/template.html` already owns one strong exact-edge surface:
