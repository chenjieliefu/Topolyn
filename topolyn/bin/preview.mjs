...
const cliPath = path.join(here, 'topolyn.mjs');
...
<head>
  ...
  <title>Topolyn Live Preview</title>
  <style>
...
<body data-state="checking" data-has-artifact="false">
  <header>
    <span class="brand">Topolyn Preview</span>
  ...
  <main>
    ...
    <iframe id="artifact" title="Verified Topolyn diagram"></iframe>
  </main>
  <script>
    (function () {
      'use strict';
    ...
    state.failure = {
      ...
      message: redactDiagnostic(
        ...
        [
          ...
          [path.resolve(here, '..'), '<topolyn-skill>'],
