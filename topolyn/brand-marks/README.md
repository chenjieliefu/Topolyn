...
Topolyn ships a bounded catalogue of 107 commonly used brands for architecture,
...
`node bin/topolyn.mjs brands capture <url> --json`, then author the returned
...
and intended referential use before adding or updating a mark. Topolyn does not
